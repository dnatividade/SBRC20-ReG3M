...
This program reads data from files:
 - broadcast-10m-collisions.log.log
 - broadcast-5m-collisions.log
 - R3G3M-10m-collisions.log
 - R3G3M-5m-collisions.log
"""
...
fileBCast10 = open('./broadcast-10m-collisions.log', 'r')
...
fileBCast5 = open('./broadcast-5m-collisions.log', 'r')
...
fileR3G3M10 = open('./R3G3M-10m-collisions.log', 'r')
...
fileR3G3M5 = open('./R3G3M-5m-collisions.log', 'r')
...
ax.set_xticklabels(('Mensagens\nde 10Mb', 'Mensagens\nde 5Mb'))
ax.legend((g1[0], g2[0]), ('Broadcast', 'ReG3M'))
#ax.yaxis.set_units(inch)
plt.ylabel('Número de colisões', fontsize=16)
ax.autoscale_view()
