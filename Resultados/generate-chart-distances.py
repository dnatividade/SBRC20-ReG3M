...
This program reads data from files:
 - broadcast-10m-distances.log.log
 - broadcast-5m-distances.log
 - R3G3M-10m-distances.log
 - R3G3M-5m-distances.log
"""
...
fileBCast10 = open('./broadcast-10m-distances.log', 'r')
...
fileBCast5 = open('./broadcast-5m-distances.log', 'r')
...
fileR3G3M10 = open('./R3G3M-10m-distances.log', 'r')
...
fileR3G3M5 = open('./R3G3M-5m-distances.log', 'r')
...
plt.ylabel('Distância alcançada (m)', fontsize=16)
ax.autoscale_view()
